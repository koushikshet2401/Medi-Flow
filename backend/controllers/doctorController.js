...
// HELPER FUNCTIONS
// this function will convert time 12hr to number of minutes since midnight;
// and return AM : PM
...
// this function will accept the obj or JSON String
...
// this function will convert doctor data in to plain text
...
// to get the doctor by id and fetch the details of doctor
...
export async function updateDoctor(req, res) {
  try {
    ...
    // if exists then update the image else show warning
    if (req.file?.path) {
      const uploaded = await uploadToCloudinary(req.file.path, "doctors");
      if (uploaded) {
