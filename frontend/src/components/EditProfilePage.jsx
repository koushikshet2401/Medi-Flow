...
// helper functions similer to the dashboard page
...
// this function will prevent from the duplicate
...
export default function EditProfilePage({ apiBase }) {
  ...
  const API_BASE = "https://medi-flow-backend.onrender.com/api/doctors";
...
//   same thing prevent duplicate slot and new slot
